...
OC_BASE_DIR = os.environ['OC_BASE_DIR']

if OC_BASE_DIR == '':
    print "environmental variable OC_BASE_DIR not set."
    sys.exit()
else:
  LOCATION = OC_BASE_DIR + "/opencog/attention/experiment/data" 
...
def netcat(hostname, port, content) :
  ...
  try:
    ...
    print "Connect failed: "#, msg.close()
    return
  s.sendall(content)
